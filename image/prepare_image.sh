...
dd if=/dev/zero of=/home/mario/reswarm-os/ReswarmOS_0.1.img bs=1M count=388
...
mkfs.fat -F 32 ${devName}p1 -n boot
...
mkfs.ext4 ${devName}p2 -L ReswarmOS
...
logging_message "check partition properties"

lsblk -lo name,path,type,fstype,size,alignment,phy-sec,label,uuid | grep ${devName} 
